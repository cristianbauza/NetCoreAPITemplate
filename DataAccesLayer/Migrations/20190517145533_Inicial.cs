    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Persona = table.Column<long>(nullable: false)
                    ...
                    TipoDocumento = table.Column<string>(maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PersonaId_Persona = table.Column<long>(nullable: true),
                    TipoContactoId_PerContTipo = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.TipoContactoId_PerContTipo,
